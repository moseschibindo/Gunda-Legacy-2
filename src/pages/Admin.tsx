  ...
  return (
    <div className="p-4 space-y-6 pb-24">
        ...
        {(['users', 'contributions', 'settings'] as const).map((tab) => (
          <button
            ...
            className={cn(
              ...
              activeTab === tab ? "bg-white text-emerald-600 shadow-sm" : "text-gray-500"
            )}
          >
            {tab}
          </button>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div 
                      ...
                      className={cn(
                        "w-12 h-12 rounded-2xl bg-emerald-50 border border-emerald-100 overflow-hidden",
      ...
      {activeTab === 'contributions' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-gray-900">All Records</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {contributions.map((c) => (
              <div key={c.id} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
                <div>
                  <p className="font-bold text-gray-900">{c.profiles?.name}</p>
                  <p className="text-gray-500 text-xs">{format(new Date(c.date), 'MMM d, yyyy')}</p>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/50 backdrop-blur-sm">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setShowAddContribution(false)} className="text-gray-400">
                <X size={24} />
              </button>
            </div>
            <div className="mb-6 flex items-center space-x-3 p-3 bg-emerald-50 rounded-2xl">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-600">{selectedUser?.phone}</p>
              </div>
            </div>
            <form onSubmit={handleAddContribution} className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none text-2xl font-bold text-emerald-600"
                />
              </div>
              <div className="space-y-1">
              ...
              <button
                type="submit"
                className="w-full py-4 bg-emerald-600 text-white font-bold rounded-2xl shadow-lg shadow-emerald-200 mt-4"
              >
                Record Payment
              </button>
            </form>
